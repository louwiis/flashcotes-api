...
const countriesRoutes = async (fastify) => {
    ...
    f.get("/:country_slug", { preHandler: checkCountryExists }, async (req, reply) => {
    ...
    f.delete("/:country_slug", { preHandler: checkCountryExists }, async (req, reply) => {
